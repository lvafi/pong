...
var Game = function () {
	function Game(element, width, height) {
		...
		this.Ball = new _Ball2.default(this.radius, this.cx, this.cy);
	}
...
var Ball = function () {
  ...
  _createClass(Ball, [{
    ...
    value: function render(svg) {
      ...
      circle.setAttributeNS(null, "r", this.radius), circle.setAttributeNS(null, "cx", this.cx), circle.setAttributeNS(null, "cy", this.cy), circle.setAttributeNS(null, "fill", "white"), svg.appendChild(circle);
    }
  }]);
